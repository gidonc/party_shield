...
Replication code and data for Bischof et. al. "When Legislators Do Not Differentiate: A Field Experiment on British MPs' Responses to Constituent Policy Queries". The material is shared in two folders, described below:
