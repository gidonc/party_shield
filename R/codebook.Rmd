---
title: 'When legislators do not differentiate: A field experiment on British MPs responses to constituent policy queries: Codebook'

# author: "Daniel Bischof, Vanessa Cheng-Matuno, Gidon Cohen, Sarah Cohen, Florian Foos,
...
main_description <- tibble::tribble(
  ...
  "const_anon_id", "id for constituency (this is a non-standard id number from a random number generator).",
...
bes17_description <- tibble::tribble(
  ...
  "MPsex2", "Gender of the winner of the seat in the 2017 General Election.",
  ...
  "mp_first_start", "Year when the MP for the seat was first elected to the House of Commons according to ParlParse data. MP is taken as the member in post at the start of the experiment (November 2018)",
  "service_duration", "Length of time the MP for the seat has served in the House of Commons (in decades) according to ParlParse data. . MP is taken as the member in post at the start of the experiment (November 2018)",
  "frontbench", "Was the MP was a minister or shadow minister during the period when we ran our experiment (November 2018-July 2019 according to ParlParse data.",
  "in_experiment", "Is constituency in the experiment (categories: Included (letters sent), Excluded (no letters))",
  "in_experimentn", "Is constituency in the experiment (categories: Included, Excluded)",
  "Region", "Government Office Region",
  "RegionNo", "Government Office Region (numeric)"
)
